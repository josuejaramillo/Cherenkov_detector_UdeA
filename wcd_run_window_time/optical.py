...
def refractive_index_TiO2(E):
    ...
    return n
print(refractive_index_TiO2(photonEnergy))

fig = plt.subplots(figsize=(10, 6))
plt.scatter(photonEnergy, refractiveIndex1, color = "crimson", label = "RI Water")
plt.scatter(photonEnergy, refractive_index_TiO2(photonEnergy), color = "navy", label = "RI TiO2")
...
plt.legend()
plt.savefig("RI_energy_water.png", dpi=300)
plt.show()